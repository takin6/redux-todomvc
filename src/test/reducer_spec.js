...
describe('reducer', () => {
  ...
  it('handleds CLEAR_COMPELTED by removing all the completed items', () => {
    const initialState = fromJS({
      todos: [
        {id: 1, text: 'React', status: 'active'},
  ...
  it('handles ADD_ITEM by adding the item', () => {
    ...
    const action = { type: 'ADD_ITEM', text: 'Redux' }
    const nexState = reducer(initialState, action);
    expect(nextState).to.equal(fromJS({
      todos: [
        {id: 1, text: 'React', status: 'active'},
        {id: 2, text: 'Redux', status: 'active'}
  ...
  it('handles DELETE_ITEM by removig the item', () => {
    const initialState = fromJS({
      todos: [
        {id: 1, text: 'React', status: 'active'},
        {id: 2, text: 'Redux', status: 'completed'},
